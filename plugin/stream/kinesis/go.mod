module github.com/DiscreteTom/rua/plugin/stream/kinesis

go 1.17

require (
	github.com/DiscreteTom/rua v0.0.0-20210826072452-060ec44a1892 // indirect
	...
	github.com/aws/aws-sdk-go-v2/service/kinesis v1.5.3 // indirect
